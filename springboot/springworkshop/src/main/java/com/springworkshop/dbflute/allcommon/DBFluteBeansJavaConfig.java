package com.springworkshop.dbflute.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="com.springworkshop.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.springworkshop.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.springworkshop.dbflute.allcommon.ImplementedInvokerAssistant();
    }
