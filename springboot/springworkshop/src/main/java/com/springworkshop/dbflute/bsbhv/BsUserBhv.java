...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
    ...
    //                                                                   =================
    /**
     * Pull out the list of foreign table 'MasterCategory'.
     * @param userList The list of user. (NotNull, EmptyAllowed)
     * @return The list of foreign table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<MasterCategory> pulloutMasterCategory(List<User> userList)
    { return helpPulloutInternally(userList, "masterCategory"); }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of User. (NotNull)
