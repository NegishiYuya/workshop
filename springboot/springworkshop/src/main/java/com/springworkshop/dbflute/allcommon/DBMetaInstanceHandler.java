...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("master_category", "com.springworkshop.dbflute.bsentity.dbmeta.MasterCategoryDbm");
        tmpMap.put("user", "com.springworkshop.dbflute.bsentity.dbmeta.UserDbm");
